...
<div class="form-container">
   ...
   <form method="post" action="">
      ...
      <input type="email" value="ulasgergerli@gmail.com" name="email" required placeholder="enter your email" >
      <input type="password" value="123" name="password" required placeholder="enter your password" >
